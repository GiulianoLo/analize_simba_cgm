...
# BLACK HOLE STUFF
# ===============================================
# almac11 Nenkova i=60 arm: identical to parameters_master.py (dust_on) except
# BH_SED=True (CLUMPY i=60) and the single sightline (see GRID INFORMATION).
...
BH_var = False
nenkova_params = [5, 30, 60, 1.5, 30, 40]  # i=60: intermediate CLUMPY view; single fixed-i transmission x Hopkins, injected isotropically
